...
path_data = r"C:\Users\Julian\HESSENBOX-DA\Projekte\Konflikte_Preprocessing\Korpora\Naturalismus"
...
for entry in paths_list:
    novels_titles.append(re.search(r"(?<=Naturalismus\\)(.*)(?=.txt)",entry).group(1))
