...
path_data = r"C:\Users\Julian\HESSENBOX-DA\Projekte\Konflikte_Preprocessing\Korpora\Realismus"
...
for entry in paths_list:
    novels_titles.append(re.search(r"(?<=Realismus\\)(.*)(?=.txt)",entry).group(1))
