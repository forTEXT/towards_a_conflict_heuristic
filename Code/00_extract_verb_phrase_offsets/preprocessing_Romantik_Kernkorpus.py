...
path_data = r"C:\Users\Julian\HESSENBOX-DA\Projekte\Konflikte_Preprocessing\Korpora\Romantik_Kernkorpus"
...
for entry in paths_list:
    novels_titles.append(re.search(r"(?<=Romantik_Kernkorpus\\)(.*)(?=.txt)",entry).group(1))
